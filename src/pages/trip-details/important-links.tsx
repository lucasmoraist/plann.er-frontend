...
export function ImportantLinks({ toggleCreateLinkModal }: ImportantLinksProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-5 ">
        <div className="flex items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <a
              href="#"
              className="block text-xs text-zinc-400 truncate hover:underline"
            >
              https://www.airbnb.com.br/rooms/104700011
            </a>
          </div>

          <Link2 className="text-zinc-200 size-5 shrink-0" />
        </div>
      ...
      <Button onClick={toggleCreateLinkModal} variant="secondary" size="full">
